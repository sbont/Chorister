<template>
  ...
  <Readings :event="event" :show-copyright="false" :is-easter="isEaster" />
...
import Readings from "./liturgy-of-the-word/Readings.vue";
import Creed from "./liturgy-of-the-word/Creed.vue";
